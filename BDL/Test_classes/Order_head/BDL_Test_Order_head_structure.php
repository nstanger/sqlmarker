 ...
 */
class BDL_Test_Order_head_structure extends BDL_Test_Order_head
{
	/**
	...
	{
		return $this->createXMLDataSet( TEST_CLASS_PATH . '/Order_head/BDL_Fixture_Order_head_Empty.xml' );
	}
