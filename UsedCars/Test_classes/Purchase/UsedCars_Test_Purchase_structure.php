 ...
 */
class UsedCars_Test_Purchase_structure extends UsedCars_Test_Purchase
{
	/**
	...
	{
		return $this->createXMLDataSet( TEST_CLASS_PATH . '/Purchase/UsedCars_Fixture_Purchase_Empty.xml' );
	}
