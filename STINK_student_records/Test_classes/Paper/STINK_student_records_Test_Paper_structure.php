 ...
 */
class STINK_student_records_Test_Paper_structure extends STINK_student_records_Test_Paper
{
	/**
	...
	{
		return $this->createXMLDataSet( TEST_CLASS_PATH . '/Paper/STINK_student_records_Fixture_Paper_Empty.xml' );
	}
