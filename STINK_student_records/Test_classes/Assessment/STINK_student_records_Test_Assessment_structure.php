 ...
 */
class STINK_student_records_Test_Assessment_structure extends STINK_student_records_Test_Assessment
{
	/**
	...
	{
		return $this->createXMLDataSet( TEST_CLASS_PATH . '/Assessment/STINK_student_records_Fixture_Assessment_Empty.xml' );
	}
